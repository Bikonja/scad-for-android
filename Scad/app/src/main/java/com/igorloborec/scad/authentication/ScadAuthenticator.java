 ...
 */
public class ScadAuthenticator extends AbstractAccountAuthenticator {

    private static final String LOG_TAG = ScadAuthenticator.class.getSimpleName();
    protected final Context mContext;

    public ScadAuthenticator(Context context) {
        super(context);
    ...
    public Bundle addAccount(AccountAuthenticatorResponse response, String accountType, String authTokenType, String[] requiredFeatures, Bundle options) throws NetworkErrorException {
        ...
        final Intent intent = new Intent(mContext, ScadAuthenticatorActivity.class);
        intent.putExtra(ScadAuthenticatorActivity.ARG_ACCOUNT_TYPE, accountType);
        intent.putExtra(ScadAuthenticatorActivity.ARG_AUTH_TYPE, authTokenType);
        intent.putExtra(ScadAuthenticatorActivity.ARG_IS_ADDING_NEW_ACCOUNT, true);
